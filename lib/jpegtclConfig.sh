...
# build directory.
jpegtcl_BUILD_LIB_SPEC='-L/home/gecko/AT-8.6.6.8607-MSWin32-x86-403667/Img/libjpeg -ljpegtcl92'

# String to pass to linker to pick up the jpegtcl library from its
# installed directory.
jpegtcl_LIB_SPEC='-LC:/tools/msys32/tmp/tcl-hblvpzclgderesjilmzowovuxmzgtgdbhcspbqzdujjelxuowjndpkdkjbkmsahtsqsfizjsxfdoplsdmhcfgyneuqvnuybousbhklku/lib/Img1.4.6 -ljpegtcl92'
...
# build directory.
jpegtcl_BUILD_STUB_LIB_SPEC='-L/home/gecko/AT-8.6.6.8607-MSWin32-x86-403667/Img/libjpeg -ljpegtclstub92'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_SPEC='-LC:/tools/msys32/tmp/tcl-hblvpzclgderesjilmzowovuxmzgtgdbhcspbqzdujjelxuowjndpkdkjbkmsahtsqsfizjsxfdoplsdmhcfgyneuqvnuybousbhklku/lib/Img1.4.6 -ljpegtclstub92'

# String to pass to linker to pick up the jpegtcl stub library from its
# build directory.
jpegtcl_BUILD_STUB_LIB_PATH='/home/gecko/AT-8.6.6.8607-MSWin32-x86-403667/Img/libjpeg/jpegtclstub92.lib'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_PATH='C:/tools/msys32/tmp/tcl-hblvpzclgderesjilmzowovuxmzgtgdbhcspbqzdujjelxuowjndpkdkjbkmsahtsqsfizjsxfdoplsdmhcfgyneuqvnuybousbhklku/lib/Img1.4.6/jpegtclstub92.lib'
