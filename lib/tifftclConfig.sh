...
# build directory.
tifftcl_BUILD_LIB_SPEC='-L/home/gecko/AT-8.6.6.8607-MSWin32-x86-403667/Img/libtiff -ltifftcl397'

# String to pass to linker to pick up the tifftcl library from its
# installed directory.
tifftcl_LIB_SPEC='-LC:/tools/msys32/tmp/tcl-hblvpzclgderesjilmzowovuxmzgtgdbhcspbqzdujjelxuowjndpkdkjbkmsahtsqsfizjsxfdoplsdmhcfgyneuqvnuybousbhklku/lib/Img1.4.6 -ltifftcl397'
...
# build directory.
tifftcl_BUILD_STUB_LIB_SPEC='-L/home/gecko/AT-8.6.6.8607-MSWin32-x86-403667/Img/libtiff -ltifftclstub397'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_SPEC='-LC:/tools/msys32/tmp/tcl-hblvpzclgderesjilmzowovuxmzgtgdbhcspbqzdujjelxuowjndpkdkjbkmsahtsqsfizjsxfdoplsdmhcfgyneuqvnuybousbhklku/lib/Img1.4.6 -ltifftclstub397'

# String to pass to linker to pick up the tifftcl stub library from its
# build directory.
tifftcl_BUILD_STUB_LIB_PATH='/home/gecko/AT-8.6.6.8607-MSWin32-x86-403667/Img/libtiff/tifftclstub397.lib'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_PATH='C:/tools/msys32/tmp/tcl-hblvpzclgderesjilmzowovuxmzgtgdbhcspbqzdujjelxuowjndpkdkjbkmsahtsqsfizjsxfdoplsdmhcfgyneuqvnuybousbhklku/lib/Img1.4.6/tifftclstub397.lib'
